def day_4 input
  # Split by line then by whitespace on each line
  lines = input.split("\n").map { |line| line.split(/\s+/) }

  # Count of how many don't have duplicates
  lines.count { |words| words.count === words.uniq.count }
end

p day_4 'pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk
